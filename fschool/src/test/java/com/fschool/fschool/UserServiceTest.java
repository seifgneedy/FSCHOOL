...
public class UserServiceTest {
    ...
    public void getCoursesOfUserInMultipleCourses(){
        ...
        when(userRepository.findById(user.getId())).thenReturn(Optional.of(user));
        List<Course> courses = userService.getCourses(userList.get(0).getId());
        assertNotNull(courses);
    ...
    public void getCoursesOfUserNotInDB(){
        ...
        List<Course> courses = userService.getCourses(9999L);
        assertNull(courses);
    }
    @Test
    public void getCourseWithCodeInDB(){
        ...
        Course course = userService.getCourse("CSE 123");
    ...
    public void getCourseWithCodeNotInDB(){
        ...
        Course course = userService.getCourse("CSE 999");
        assertNull(course);
    }
}
